    ...
    <holder class="padding-8">
        ...
        <div class="content-box light-color padding-32 border-radius-16">
            <p class="headline-small outline-text dm-sans text-wrap-pretty">
                Proyecto totalmente desarrollado, programado y diseñado por <span class="primary-text weight-500">Luis David Elizarraraz Mondaca</span>,
                con la colaboración de <span class="primary-text weight-500">Álvaro Pérez March</span>
            </p>
